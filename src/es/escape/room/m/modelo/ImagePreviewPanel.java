...
/**
 * Clase para repintar el visualizador de imagenes del JFileChooser
 */
public class ImagePreviewPanel extends JPanel
        implements PropertyChangeListener {
 
	private static final long serialVersionUID = -4771695635711592576L;
    ...
    /**
     * Change the status of the previewer and load the new image
     */
    public void propertyChange(PropertyChangeEvent e) {
        ...
        if (propertyName.equals(JFileChooser.SELECTED_FILE_CHANGED_PROPERTY)) {
            ...
            if ((name != null) &&
                    ...
                    name.toLowerCase().endsWith(".bpg")) {
                icon = new ImageIcon(name);
                image = icon.getImage();
                scaleImage();
                
            }else{
            	//If is not an image , set the image to null to avoid preview
            	image = null;
            }
